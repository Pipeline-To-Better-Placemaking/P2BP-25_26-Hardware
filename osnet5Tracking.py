...
from osnet_x0_5.encoder import OsNetEncoder  # OSNet x0.5
...
# ---------------- OSNet x0.5 MSMT17 ----------------
weights_path = "osnet_x0_5/osnet_x0_5_msmt17_combineall_256x128.pth"
...
osnet = OsNetEncoder(
    ...
    batch_size=32,
    num_classes=1041,  # MSMT17 classes
    patch_height=256,
    patch_width=128,
        ...
        while not self.stop_event.is_set() or not self.frame_queue.empty():
            ...
            with YOLO_LOCK:
                results = YOLO_MODEL.track(
                    frame, conf=CONF_THRESH, imgsz=IMG_SIZE,
